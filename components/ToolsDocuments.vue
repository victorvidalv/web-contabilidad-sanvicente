...
<template>
  <div class="container mx-auto my-10 p-5 border">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <!-- Enlace de Formalización -->
      <a 
        href="https://forms.gle/VVpHuzGa8RsZXKSd7" 
        target="_blank" 
      ...
      >
        ...
        <h2 class="text-xl font-semibold mb-2">Formalización</h2>
        <p class="text-gray-500 text-center mb-4">Formulario para el proceso de formalización de empresas y servicios</p>
        <span class="bg-blue-950 text-white px-4 py-2 rounded-full text-sm font-medium hover:bg-blue-800">Completar formulario</span>
      </a>

      <!-- Enlace de Registro -->
      <a 
        href="https://forms.gle/jwrg3yq9x3hkjPgM9" 
        target="_blank" 
        rel="noopener noreferrer" 
        class="flex flex-col items-center p-6 border rounded-lg hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300"
      >
