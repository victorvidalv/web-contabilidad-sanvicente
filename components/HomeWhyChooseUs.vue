  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="mt-5 lg:mt-16 grid lg:grid-cols-3 gap-8 lg:gap-12">
      <div class="lg:col-span-1">
        <h2 class="font-bold text-2xl md:text-3xl text-gray-600">
          ¿Por qué elegirnos?
        </h2>
        <p class="mt-2 md:mt-4 text-gray-600">
          En nuestra firma, situada en <strong>San Vicente de Tagua Tagua</strong>, ofrecemos mucho más que servicios
          contables tradicionales; somos tu aliado estratégico para navegar por el complejo paisaje contable.
        </p>
      </div>
      <!-- -->
      ...
      <div class="lg:col-span-2">
        <div class="grid sm:grid-cols-2 gap-8 md:gap-12">
          ...
          <div class="flex gap-x-5">
            ...
            <svg class="flex-shrink-0 mt-1 w-10 h-10 text-orange-600" xmlns="http://www.w3.org/2000/svg" width="16"
            ...
            <div class="grow">
              <h3 class="text-lg font-semibold text-gray-600">
                Experiencia y Diversidad en el Equipo de Trabajo
              </h3>
              <p class="mt-1 text-gray-600">
                Contamos con un equipo multidisciplinario de profesionales con más de 10 años de experiencia en áreas
                contables, comerciales e informáticas.
              </p>
            </div>
          </div>
          <!--  -->
          ...
          <div class="flex gap-x-5">
            ...
            <div class="grow">
              <h3 class="text-lg font-semibold text-gray-600">
                Amplia Gama de Servicios Personalizados
              </h3>
              <p class="mt-1 text-gray-600">
                Nuestra firma ofrece una extensa variedad de servicios que van más allá de la contabilidad financiera y la
                asesoría tributaria.
              </p>
            </div>
          </div>
          ...
          <div class="flex gap-x-5">
            ...
            <div class="grow">
              ...
              <p class="mt-1 text-gray-600">
                Nuestra visión moderna de la contabilidad integra tecnología y análisis de datos en todas nuestras
                operaciones.
              </p>
            </div>
          </div>
          ...
          <div class="flex gap-x-5">
            ...
            <div class="grow">
              ...
              <p class="mt-1 text-gray-600">
              Uno de nuestros pilares fundamentales es el compromiso con la ética profesional y la transparencia en
