<template>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="py-10">
            ...
            <p class="text-gray-500">Nos distinguimos por nuestro enfoque en soluciones contables integrales, respaldadas
                por tecnología avanzada y análisis de datos detallado. <strong>En un mercado cada vez más competitivo y desafiante,
                transformamos datos crudos en insights valiosos</strong> que impulsan su toma de decisiones estratégicas.</p>
        </div>
        <!-- Fin Título -->
  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6 md:gap-10">
    ...
    <div class="w-full h-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
      <div class="flex items-center gap-x-4 mb-3">
        ...
        <div class="flex-shrink-0">
          <h3 class="block text-lg font-semibold text-gray-800 dark:text-white">Básicos de Contabilidad</h3>
        </div>
      </div>
      <p class="text-gray-600 dark:text-gray-400">Busco servicios básicos de contabilidad, quiero la creación de registros contables precisos, la generación de estados financieros o gestión de remuneraciones.</p>
    </div>
    <!-- End Card -->
    ...
    <div class="w-full h-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
      <div class="flex items-center gap-x-4 mb-3">
        ...
        <div class="flex-shrink-0">
          <h3 class="block text-lg font-semibold text-gray-800 dark:text-white">Cumplimiento y Regulación</h3>
        </div>
      </div>
      <p class="text-gray-600 dark:text-gray-400">Necesito servicios que se enfoquen en asegurar que mi empresa cumpla con las regulaciones fiscales y legales vigentes en Chile. </p>
    </div>
    <!-- End Card -->
    ...
    <div class="w-full h-full bg-white shadow-lg rounded-lg p-5 dark:bg-slate-900">
      <div class="flex items-center gap-x-4 mb-3">
        ...
        <div class="flex-shrink-0">
          <h3 class="block text-lg font-semibold text-gray-800 dark:text-white">Servicios Estratégicos y de Gestión</h3>
        </div>
      </div>
      <p class="text-gray-600 dark:text-gray-400">Quiero un enfoque más estratégico y de gestión. Esto abarca desde la administración de nóminas y la evaluación financiera para la toma de decisiones estratégicas, hasta la asesoría en fusiones y adquisiciones, la consultoría estratégica para el crecimiento de la empresa, y la gestión de riesgos financieros. También se incluyen servicios relacionados con la creación y cierre de empresas, junto con la gestión de la tesorería, que se enfoca en la liquidez y el flujo de efectivo. Estos servicios son fundamentales para la planificación a largo plazo y la eficiencia operativa de las empresas chilenas..</p>
    </div>
    <!-- End Card -->
...
<style>
/* Estilos para el efecto de cambio de color en hover */
.trick:hover {
    color: black;
