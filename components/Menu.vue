...
<img src="https://dummyimage.com/200x60/eee/aaa" alt="Image Description" loading="lazy">
    ...
    <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
      <div class="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
        <nuxt-link class="font-medium text-white sm:py-6" to="/">Inicio</nuxt-link>
        <nuxt-link class="font-medium text-white/[.8] hover:text-white sm:py-6" to="/nosotros">Nosotros</nuxt-link>
        <nuxt-link class="font-medium text-white/[.8] hover:text-white sm:py-6" to="/servicios">Servicios</nuxt-link>
        <nuxt-link class="font-medium text-white/[.8] hover:text-white sm:py-6" to="/contacto">Contacto</nuxt-link>
