<template>
  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
      ...
      <div class="mt-5 sm:mt-10 lg:mt-0  p-5 bg-blue-950 ">
        <div class="space-y-6 sm:space-y-8 banner">
          ...
          <div class="space-y-2 md:space-y-4 ">
            ...
            <p class="text-white">
              Aquí, donde la agroindustria y el comercio dibujan el paisaje económico, nos enorgullece ofrecer una amplia
              gama de servicios que van desde la Contabilidad Financiera hasta la Consultoría Estratégica y Servicios de
              Tesorería.
            </p>
          </div>
          <!-- Fin Título -->
          ...
          <ul role="list" class="space-y-2 sm:space-y-4">
            ...
            <li class="flex space-x-3">
              ...
              <span class="text-sm sm:text-base text-white ">
                Uso de <span class="font-bold">Tecnologías avanzadas</span>
              </span>
            </li>
