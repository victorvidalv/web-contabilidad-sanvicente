  ...
  <div class="container mx-auto my-10 p-5 border">
    ...
    <table class="min-w-full bg-white">
      <thead class="bg-blue-950 text-white">
        <tr>
          <th class="w-1/4 py-2 text-justify p-4">Nombre</th>
          <th class="w-1/4 py-2 text-justify p-4">Valor</th>
          <th class="w-1/4 py-2 text-justify p-4">Unidad de Medida</th>
          <th class="w-1/4 py-2 text-justify p-4">Fecha</th>
        </tr>
      </thead>
